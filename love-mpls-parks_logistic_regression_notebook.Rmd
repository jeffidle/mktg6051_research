---
title: "Park usage and brand preference logistic regression and correlation analysis"
...
This is a logistic regression and correlation analysis of survey results to assess linkages between park usage and brand/product preferences.
...
data_df <- vroom("all_data_regression_numeric.csv", progress = FALSE)
...
data_r1n_df <- data_df %>%
        select(freq_park_usage, park_run_walk, park_biking, park_skiing, park_team_sports,
...
m_allvars <- glm(freq_park_usage ~., data = data_r1n_df, family = binomial)
...
logistic_formula_fx(tidy_m_allvars, "Frequent Park Usage")
